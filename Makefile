...
copy-schemas: \
	repo/spec \
	$(IMPL_NAME)-backend/src/schemas/model-evaluation-schema.json \
...
$(IMPL_NAME)-backend/src/schemas/model-evaluation-schema.json: repo/spec/model-evaluation-schema.json
	cp $< $@
